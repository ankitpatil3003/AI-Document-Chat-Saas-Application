...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-br from-slate-900 to-cyan-800">
      <div className="bg-slate-800 py-24 sm:py-32 rounded-md drop-shadow-2xl">
